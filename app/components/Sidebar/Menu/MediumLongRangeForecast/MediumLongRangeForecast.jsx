...
export default function MediumLongRangeForecast(){
    ...
    return (
        ...
        >
            ...
            >
                <Typography>MEDIUM AND LONG RANGE FORECAST</Typography>
            </AccordionSummary>
            <AccordionDetails>
                <List>
                    <ListItemButton
                    ...
                    >
                        <ListItemText primary="Flood Forecast" />
                    </ListItemButton>
                    <ListItemButton
                        selected={selectedIndex === 1}
                        onClick={(event) => handleListItemClick(event, 1)}
                    >
                        <ListItemText primary="Drought Forecast" />
                    </ListItemButton>
                    <ListItemButton
